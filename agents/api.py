"""
FastAPI REST API Server for Clinical Pathway Variance Agent.
"""
...
app = FastAPI(
    title="Clinical Pathway Variance Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "clinical-pathway-variance-agent", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
