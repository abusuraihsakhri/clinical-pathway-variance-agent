"""
FastAPI REST API Server for PathwayVariance: Enhanced Recovery After Surgery (ERAS) Adherence Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="PathwayVariance: Enhanced Recovery After Surgery (ERAS) Adherence Agent",
            description="Tracks surgical patient progress against ERAS multimodal pathways (early mobilization, opioid sparing, early feeding).",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "clinical-pathway-variance-agent", "domain": "Clinical Operations", "version": "2.0.0-FRONTIER"}
